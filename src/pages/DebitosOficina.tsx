...
export default function DebitosOficina() {
  return (
    <div className="space-y-6">
      <PageHeader title="Débitos Oficina" subtitle="Controle financeiro de débitos de manutenção." />

      <div className="bg-white border border-slate-100 rounded-xl p-10 text-center shadow-sm">
        <span className="text-5xl block mb-4">⚠️</span>
        <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-2">Débitos Oficina</h3>
        <p className="text-xs text-slate-400 leading-relaxed max-w-md mx-auto mb-6">
          Controle financeiro de débitos de manutenção.
