...
export default function Funcionarios() {
  return (
    <div className="space-y-6">
      <PageHeader title="Funcionários" subtitle="Cadastro e gestão de colaboradores da empresa." />

      <div className="bg-white border border-slate-100 rounded-xl p-10 text-center shadow-sm">
        <span className="text-5xl block mb-4">👤</span>
        <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-2">Funcionários</h3>
        <p className="text-xs text-slate-400 leading-relaxed max-w-md mx-auto mb-6">
          Cadastro e gestão de colaboradores da empresa.
