...
export default function ObrasProjetos() {
  return (
    <div className="space-y-6">
      <PageHeader title="Obras & Projetos" subtitle="Gestão de obras públicas e privadas com centros de custo." />

      <div className="bg-white border border-slate-100 rounded-xl p-10 text-center shadow-sm">
        <span className="text-5xl block mb-4">🏗️</span>
        <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider mb-2">Obras & Projetos</h3>
        <p className="text-xs text-slate-400 leading-relaxed max-w-md mx-auto mb-6">
          Gestão de obras públicas e privadas com centros de custo.
