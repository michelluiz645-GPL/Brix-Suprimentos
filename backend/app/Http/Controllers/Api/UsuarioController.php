...
class UsuarioController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $data = $request->validate([
            ...
            'responsabilidades.requisicao_almoxarifado'       => ['sometimes', 'array'],
            'responsabilidades.requisicao_almoxarifado.*'     => [Rule::in(Modulo::RESPONSABILIDADES_REQUISICAO_ALMOXARIFADO)],
